...
latex_documents = [
    (master_doc, 'amplimap.tex', u'amplimap Documentation',
     u'Nils Koelling', 'manual'),
]
...
man_pages = [
    (master_doc, 'amplimap', u'amplimap Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'amplimap', u'amplimap Documentation',
     author, 'amplimap', 'One line description of project.',
     'Miscellaneous'),
]